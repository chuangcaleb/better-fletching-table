...
execute if score @s cc.ft.raycast_counter matches ..25 if block ~ ~ ~ #cchesed:bft/transparent positioned ^ ^ ^0.2 run function cchesed:bft/items/tntt/block/raycast_loop

# If found block, run function
execute if block ~ ~ ~ minecraft:target align xyz positioned ~0.5 ~ ~0.5 run function cchesed:bft/items/tntt/block/upgrade
