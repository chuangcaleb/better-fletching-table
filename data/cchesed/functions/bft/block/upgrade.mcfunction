...
summon llama ~ ~ ~ {NoGravity:1b,Silent:1b,Invulnerable:1b,CustomNameVisible:0b,DeathLootTable:"cchesed:bft/nothing",PersistenceRequired:1b,NoAI:1b,InLove:2147483647,Tame:1b,Strength:3,ChestedHorse:1b,Tags:["cc.ft.llama","cc.ft.table"],CustomName:'{"text":"Fletching Table","italic":false}',ActiveEffects:[{Id:14,Amplifier:1b,Duration:2147483647,ShowParticles:0b}],DecorItem:{id:"minecraft:-1",Count:1b}}
# TODO: Invulnerable
