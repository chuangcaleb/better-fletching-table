...
# TODO: Invulnerable
summon armor_stand ~ ~-0.97 ~ {CustomNameVisible:0b,Silent:1b,Invulnerable:1b,Invisible:1b,Marker:1b,PersistenceRequired:1b,Tags:["cc.ft.table","cc.ft.astand"],ArmorItems:[{},{},{},{id:'minecraft:crafting_table',Count:1b}],CustomName:'{"text":"Fletching Table","italic":false}'}
