...
execute if score @s cc.ft.output_id matches 22 run data modify entity @e[limit=1,tag=cc.ft.drop_item] Item set value {id: "minecraft:tipped_arrow", Count: 2b, tag: {display: {Name: '{"text":"Fire-Charged Arrow","italic":false}'}, HideFlags: 32, CustomPotionColor: 16765762, cchesed: {bft: {fire: 1b}}}}
